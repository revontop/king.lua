...
local window = library:AddWindow("REVY PRIVATY", {
	title_bar = {Color3.fromRGB(35, 35, 40), Color3.fromRGB(115, 0, 0), Color3.fromRGB(50, 0, 0)}, -- Title Bar Gradient (1-3 Colors)
	...
	min_size = Vector2.new(1200, 1000), -- Size of the Window (vertically, horizontally)
